...
async function estimateCommand(input, context) {
  ...
  try {
    ...
    if (useCurrentContext) {
      ...
      console.log('\n📊 Estimating cost for current conversation context...\n');
    ...
    console.log('─'.repeat(60));
    console.log('');
    console.log('   Note: Actual cost may vary based on:');
    ...
    console.log(`Error estimating cost: ${error.message}`);
  }
}
