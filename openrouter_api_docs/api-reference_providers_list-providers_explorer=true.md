---
url: "https://openrouter.ai/docs/api-reference/providers/list-providers?explorer=true"
...
GEThttps://openrouter.ai/api/v1/providers

Send Request

Enter your bearer tokenNot Authenticated

Use exampleClear form [View in API Reference](https://openrouter.ai/docs/api-reference/providers/list-providers)
