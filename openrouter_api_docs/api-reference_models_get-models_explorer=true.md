---
url: "https://openrouter.ai/docs/api-reference/models/get-models?explorer=true"
...
4 optional propertiescategory, supported\_parameters, use\_rss, use\_rss\_chat\_links

Use exampleClear form [View in API Reference](https://openrouter.ai/docs/api-reference/models/get-models)
