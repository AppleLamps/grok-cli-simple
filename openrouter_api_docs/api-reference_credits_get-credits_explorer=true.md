---
url: "https://openrouter.ai/docs/api-reference/credits/get-credits?explorer=true"
...
GEThttps://openrouter.ai/api/v1/credits

Send Request

Enter your bearer tokenNot Authenticated

Use exampleClear form [View in API Reference](https://openrouter.ai/docs/api-reference/credits/get-credits)
