---
url: "https://openrouter.ai/docs/api-reference/analytics/get-user-activity?explorer=true"
...
GEThttps://openrouter.ai/api/v1/activity
...
1 optional propertydate

Use exampleClear form [View in API Reference](https://openrouter.ai/docs/api-reference/analytics/get-user-activity)
