---
url: "https://openrouter.ai/docs/api-reference/api-keys/list?explorer=true"
...
2 optional propertiesinclude\_disabled, offset

Use exampleClear form [View in API Reference](https://openrouter.ai/docs/api-reference/api-keys/list)
