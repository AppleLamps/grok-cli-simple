---
url: "https://openrouter.ai/docs/api-reference/api-keys/create-keys?explorer=true"
...
Use exampleClear form [View in API Reference](https://openrouter.ai/docs/api-reference/api-keys/create-keys)
