---
url: "https://openrouter.ai/docs/api-reference/generations/get-generation?explorer=true"
...
Use exampleClear form [View in API Reference](https://openrouter.ai/docs/api-reference/generations/get-generation)
